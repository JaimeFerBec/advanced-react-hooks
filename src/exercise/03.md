...
I learnt how to use React Context, but critically when, and specially, when NOT tu use it, as well as some alternatives (such as props drilling i.e. threading/piercing props through components, or composition if we want to avoid props drilling, as shown in the [linked tweet/youtube video by Michael Jackson](https://twitter.com/mjackson/status/1195495535483817984)).
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=03%3A%20useContext%3A%20simple%20Counter&em=jaime.ferbec%40gmail.com).
