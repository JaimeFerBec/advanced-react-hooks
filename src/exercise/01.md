...
I learnt how to use `useReducer` and how it relates to `useState`. Not only how to use it, but when and why. The blog posts where particularly illustrative (*Should I useState or useReducer?*, *How to implement useState with useReducer*).
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=01%3A%20useReducer%3A%20simple%20Counter&em=jaime.ferbec%40gmail.com).
